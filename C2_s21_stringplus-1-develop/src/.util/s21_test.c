...
#line 181
  char str[100] = "davosdim";
  char simv = 'i';
  char *res = memchr(str, simv, 8);
  char *res_s21 = s21_memchr(str, simv, 8);
  char str_1[100] = "davosdim";
  char simv_1 = 'x';
  char *res_1 = memchr(str, simv, 8);
  char *res_1_s21 = s21_memchr(str_1, simv_1, 8);
  char str_2[100] = "";
  char simv_2 = 'h';
  char *res_2 = memchr(str_2, simv_2, 8);
  char *res_2_s21 = s21_memchr(str_2, simv_2, 8);

  ck_assert_str_eq(res, res_s21);
  ck_assert_str_eq(res_1, res_1_s21);
  ck_assert_str_eq(res_2, res_2_s21);
}
END_TEST
...
#line 356
  ...
  for (int i = 0; i < tests; i++) {
    ...
    ck_assert_str_eq(str_39, str_39);
  }
}
END_TEST
...
#line 468
  ...
  char str_71[100] = "!!!";
  char *res_34 = NULL;
  char *res_34_s21 = s21_insert(str_70, str_71, 13);
  char *str_72 = NULL;
  char *str_73 = "b";
  char *res_35 = NULL;
  ...
  ck_assert_int_eq(res_34 == NULL, res_34_s21 == NULL);
...
#line 487
  char str_74[100] = "zcapitalzzz of Sakhalinz Island Yuzhnozz-Sakhalinsk";
  char str_75[100] = "z";
  char *res_36 = "capital of Sakhalin Island Yuzhno-Sakhalinsk";
  char *res_36_s21 = s21_trim(str_74, str_75);
  ...
  ck_assert_str_eq(res_36, res_36_s21);
...
int main(void) {
  ...
  tcase_add_test(tc1_1, s21_spritf_one_c);
